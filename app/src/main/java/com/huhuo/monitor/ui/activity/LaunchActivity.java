...
public class LaunchActivity extends AppCompatActivity {
    ...
    private void startLogin(String mobile) {
        final RequestParams params = new RequestParams(Constants.getLoginUrl(mobile));
        if(NetWorkUtil.isNetWorkEnable(getApplicationContext())) {
            HttpHelper.post(params, new SimpleHttpRequestCallBack<String>() {
                ...
                public void onError(Throwable ex, boolean isOnCallback) {
                    ToastUtil.showShortToast("网络异常，请检查您的网络");
                    toLoginOrIn2Main();
                }
            });
        } else {
