    ...
    public static boolean isNetWorkEnable(Context context) {
        try {
            ...
            if (connectivity == null) {
                ToastUtil.showShortToast(R.string.test_cant_conn_net);
                return false;
            }
        ...
        ToastUtil.showMessage(R.string.test_cant_conn_net);
        return false;
    }
...
//	// 适配低版本手机
    ...
    public static String getCurrentNetworkType() {
        ...
        String typeUnknownStr = context.getString(R.string.common_unknown);
        String type = typeUnknownStr;
        switch (networkClass) {
            case NETWORK_CLASS_UNAVAILABLE:
                type = context.getString(R.string.common_not);
                break;
    ...
    private static String getMacFromCallCmd() {
        ...
        Logger.v("tag", "cmd result : " + result);
